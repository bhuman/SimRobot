...
target_link_libraries(SimRobotCore3 PRIVATE Qt6::Core Qt6::Gui Qt6::OpenGL Qt6::Widgets)
target_compile_definitions(SimRobotCore3 PUBLIC SIMROBOTCORE3_USE_OPENGL)
if(Qt6_VERSION VERSION_GREATER_EQUAL "6.7.0")
  target_compile_definitions(SimRobotCore3 PUBLIC SIMROBOTCORE3_USE_QRHI)
  target_link_libraries(SimRobotCore3 PRIVATE Qt6::GuiPrivate)
else()
  target_link_libraries(SimRobotCore3 PRIVATE Qt6::OpenGLWidgets)
endif()
