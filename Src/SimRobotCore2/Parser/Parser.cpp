...
Parser::Parser() : errors(0), sceneMacro(0), recordingMacroElement(0), replayingMacroElement(0), element(0), elementData(0), passedSimulationTag(false)
{
  static const ElementInfo elements[] =
  {
    ...
    {"Appearance", appearanceClass, &Parser::appearanceElement, 0, 0,
      0, translationClass | rotationClass, setClass | appearanceClass},
    {"BoxAppearance", appearanceClass, &Parser::boxAppearanceElement, 0, 0,
      surfaceClass, translationClass | rotationClass, setClass | appearanceClass},
    {"SphereAppearance", appearanceClass, &Parser::sphereAppearanceElement, 0, 0,
      surfaceClass, translationClass | rotationClass, setClass | appearanceClass},
    {"CylinderAppearance", appearanceClass, &Parser::cylinderAppearanceElement, 0, 0,
      surfaceClass, translationClass | rotationClass, setClass | appearanceClass},
    {"CapsuleAppearance", appearanceClass, &Parser::capsuleAppearanceElement, 0, 0,
      surfaceClass, translationClass | rotationClass, setClass | appearanceClass},
    {"ComplexAppearance", appearanceClass, &Parser::complexAppearanceElement, 0, 0,
