/**
 * @file ConvexGeometry.h
 *
 * This file declares a convex polygon geometry class.
 *
...
{
public:
  std::vector<b2Vec2> vertices; /**< The vertices of the polygon. The interior is to the left of each edge. */
  QColor color; /**< The color in which to draw the geometry. */

protected:
  /**
   * Creates an instance of the convex polygon shape.
