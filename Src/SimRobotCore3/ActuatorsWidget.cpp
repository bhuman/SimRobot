...
ActuatorWidget::ActuatorWidget(SimRobotCore3::ActuatorPort* actuator, QWidget* parent) : QWidget(parent),
...
void ActuatorsWidget::openActuator(const QString& actuatorName)
{
  ...
  SimRobotCore3::ActuatorPort* actuator = static_cast<SimRobotCore3::ActuatorPort*>(CoreModule::application->resolveObject(actuatorName, SimRobotCore3::actuatorPort));
  if(!actuator)
    return;
