...
{ return QString::localeAwareCompare_helper(constData(), length(), s.data(), static_cast<int>(s.size())); }
...
{ return QString::localeAwareCompare_helper(s1.data(), static_cast<int>(s1.size()), s2.data(), static_cast<int>(s2.size())); }
